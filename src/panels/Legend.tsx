...
/** Marker glyphs, matching the shapes the canvas draws. */
const GLYPHS: Record<EventCategory, string> = {
  kill: 'M8 1 L9.6 6.4 L15 8 L9.6 9.6 L8 15 L6.4 9.6 L1 8 L6.4 6.4 Z',
  death:
    'M3.4 1.6 L8 6.2 L12.6 1.6 L14.4 3.4 L9.8 8 L14.4 12.6 L12.6 14.4 L8 9.8 L3.4 14.4 L1.6 12.6 L6.2 8 L1.6 3.4 Z',
        ...
        {CATEGORIES.map((category) => (
          <li key={category} className="flex items-center gap-2.5">
            <svg width="26" height="14" viewBox="-5 0 26 16" aria-hidden>
              <path d={GLYPHS[category]} fill={cssColor(EVENT_COLOR[category])} />
            </svg>
